...
Item {
    ...
    function show(mode, path, winId) {
        ...
        folderContent.model = context.getFolderModel(currPath)
        root.visible = true
    }
    ...
    Column {
        ...
        Text {
            ...
            text: pickerMode == 0 ? "Select file" : (pickerMode == 1 ? "Select folder" : "Select files")
        }
        ...
        ListView {
            ...
            clip: true
            width: parent.width - 20
            height: Math.min(root.height - 160, contentHeight)
            delegate: Item {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        if (modelData[1] == 0) {
                            currPath = context.getFolderCleanPath(item)
                            var emptyArr = []
                            root.selectedItems = emptyArr
                        }
                        else {
